...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(animals){
    const ret = [];
    animals.forEach(el => ret.push(`name: ${el.animal_name}, scientific: ${el.scientific_name}`));
    return ret;
  }
  ...
  */
  ...
  function lowerCaseNames(animals){
    return animals.map(function(el) {
  ...
  */
  ...
  function lowPopulationAnimals(animals){
    return animals.filter(el => el.population < 5);
  }
  ...
  */
  ...
  function USApop(animals){
    return animals.reduce((acc, el) => acc + el.population, 0);
  }
